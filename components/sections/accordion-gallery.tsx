...
export const NOCTURNE_GALLERY_ITEMS: readonly NocturneGalleryItem[] = [
  {
    ...
    alt: "Nocturne Studio com um workspace aberto, conversa central e painéis de agente, atividade e artefatos",
    image: "/nocturne-studio/workspace.png",
  },
  {
    id: "review-mode",
    label: "Review Mode",
    ...
    alt: "Detalhe de uma sugestão do Nocturne Studio com evidências, histórico, arquivos afetados e solução proposta",
    image: "/nocturne-studio/suggestion-detail.png",
  },
  {
    id: "awareness",
    ...
    alt: "Painel Sugestões do Nocturne Studio mostrando a saúde do projeto e dimensões de análise",
    image: "/nocturne-studio/suggestions.png",
  },
  {
    id: "providers",
    label: "Providers",
    ...
    alt: "Tela de configurações do Nocturne Studio com opções de acesso a diferentes provedores de IA",
    image: "/nocturne-studio/ai-settings.png",
  },
] as const;
